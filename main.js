const client = contentful.createClient({
  space: "87wt5e554kta",
  accessToken: "R-uTyyik3fSXerBx9JdSafAEEm8Cu-0xUQ08EvjHijw",
});
...
document.addEventListener("DOMContentLoaded", () => {
  const handleShopNowBtnClick = () => {
    productsSection.scrollIntoView({ behavior: "smooth" });
  };
  shopNowBtn.addEventListener("click", handleShopNowBtnClick);
});
  ...
  async getProducts() {
    try {
      let contentful = await client.getEntries({
        content_type: "kiyaHomeFurnituredeco",
      });
